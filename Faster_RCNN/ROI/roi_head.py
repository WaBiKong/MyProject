...
from utils import det_utils, boxes as box_ops
from ROI.fastrcnn_loss import fastrcnn_loss
...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        # 接着分别预测目标类别和边界框回归参数，获得预测标签和预测边界框回归参数
        ...
        if self.training:
            ...
            # 将测标签、预测边界框回归参数与真实标签、真实边界框回归信息带入损失函数
    ...
    def select_training_samples(self,
        ...
        # 将gt_boxes拼接到proposal后面，由于proposal中正样本数太少，所以把gt box加进去当初正样本
